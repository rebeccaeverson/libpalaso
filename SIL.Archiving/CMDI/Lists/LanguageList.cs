...
{
	/// -------------------------------------------------------------------------------------------
	public class LanguageItem : CMDIListItem
	{
		/// <summary>Constructs a new LanguageItem</summary>
		/// <param name="englishName">Example: "English"</param>
		/// <param name="cmdiCode">Example: "ISO639-3:eng"</param>
		internal LanguageItem(string englishName, string cmdiCode) : base(cmdiCode, englishName) { }

		internal LanguageItem(string englishName, string cmdiCode, string otherName) : this(englishName, cmdiCode)
		{
			OtherName = otherName;
		}
	...
	/// -------------------------------------------------------------------------------------------
	public class LanguageList : CMDIItemList
	{
		...
		/// ---------------------------------------------------------------------------------------
		/// <summary>Overriden so that the List contains LanguageItems rather than CMDIListItems</summary>
