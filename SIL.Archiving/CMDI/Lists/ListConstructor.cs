...
namespace SIL.Archiving.CMDI.Lists
{
	...
	{
		private static readonly Dictionary<string, CMDIItemList> _loadedLists = new Dictionary<string, CMDIItemList>();
		...
		public static CMDIItemList GetList(string listName, bool uppercaseFirstCharacter, Func<string, string, string, string, string> localize)
		{
		...
		public static CMDIItemList GetList(string listName, bool uppercaseFirstCharacter,
			Func<string, string, string, string, string> localize, RemoveUnknown removeUnknown)
		{
			...
			{
				list = new CMDIItemList(listName, uppercaseFirstCharacter, removeUnknown);
		...
		/// ---------------------------------------------------------------------------------------
		/// <summary>>Returns a list of CMDIListItems that can also be used as the data source of a combo or list box</summary>
		/// <param name="listName"></param>
		/// <param name="uppercaseFirstCharacter"></param>
		/// <returns></returns>
		public static CMDIItemList GetClosedList(string listName, bool uppercaseFirstCharacter = true)
		{
		...
		/// <returns></returns>
		public static CMDIItemList GetClosedList(string listName, bool uppercaseFirstCharacter, RemoveUnknown removeUnknown)
		{
