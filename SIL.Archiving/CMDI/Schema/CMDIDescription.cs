...
{
	/// <summary>Common description code for multiple CMDI objects</summary>
	public abstract class CMDIDescription
	{
		...
		{
			Description.Add(description.ToCMDIDescriptionType());
		}
	}
	...
	public class DescriptionTypeCollection : HashSet<DescriptionType>
	{
		...
		{
			Add(description.ToCMDIDescriptionType());
		}
	}
