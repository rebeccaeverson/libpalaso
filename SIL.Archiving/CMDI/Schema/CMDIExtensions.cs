...
{
	/// <summary>Extension methods to simplify access to CMDI objects</summary>
	public static class CMDIExtensions
	{
		...
		/// <returns></returns>
		public static LocationType ToCMDILocationType(this ArchivingLocation archivingLocation)
		{
		...
		/// <returns></returns>
		public static DescriptionType ToCMDIDescriptionType(this LanguageString langString)
		{
		...
		//public static Actor_Type ToCMDIActorType(this ArchivingActor archivingActor)
		//{
		...
		//    // languages
		//    ClosedCMDIItemList boolList = ListConstructor.GetClosedList(ListType.Boolean);
		...
		//    // Sex
		//    ClosedCMDIItemList genderList = ListConstructor.GetClosedList(ListType.ActorSex);
